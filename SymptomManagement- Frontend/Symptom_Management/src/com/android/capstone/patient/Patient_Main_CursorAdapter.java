...
public class Patient_Main_CursorAdapter extends CursorAdapter {
	...
	public static class ViewHolder {
        ...
        public ViewHolder(View view) {
        	tvName = (TextView) view.findViewById(R.id.tv_doctorListItem);
	...
	public Patient_Main_CursorAdapter(Activity activity, Cursor c, int flags) {
